 ...
 */
@Singleton
class ModelAssetController @Inject()(cc: ControllerComponents, modelService: ModelAssetService) extends
   ...
   */
  def addAssetType(): Action[AnyContent] = Action.async { implicit request: Request[AnyContent] =>
   ...
   * @return model overview page with optional error message
   */
  def deleteAssetType(id: Long): Action[AnyContent] = Action.async { implicit request: Request[AnyContent] =>
  ...
  def searchAssetType(): Action[AnyContent] = Action.async { implicit request: Request[AnyContent] =>
    //FIXME
   ...
   */
  def postAssetType(id: Long): Action[AnyContent] = Action.async { implicit request: Request[AnyContent] =>
   ...
   */
  def addAssetConstraint(assetTypeId: Long): Action[AnyContent] = Action.async { implicit request: Request[AnyContent] =>
   ...
   */
  def deleteAssetConstraint(assetTypeId: Long, constraintId: Long): Action[AnyContent] = Action.async { implicit request: Request[AnyContent] =>
