...
class CollectionService @Inject()(typeRepository: TypeRepository,
  ...
  // */
  //def getCollectionHeaders(groupSelector: Option[String] = None)(implicit ticket: Ticket): Future[Seq[ExtendedCollection]] = {
  //  try {
  //    //TODO
  //  } catch {
  //    case e: Throwable => Future.failed(e)
  ...
  // */
  //def getCollectionComplex(groupSelector: Option[String] = None)(implicit ticket: Ticket): Future[CollectionTypeComplex] = {
  //  try {
  //    //TODO
  //  } catch {
  //    case e: Throwable => Future.failed(e)
