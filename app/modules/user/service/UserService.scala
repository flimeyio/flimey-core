...
import modules.user.model.{GroupMembership, GroupStats, Role, User}
...
class UserService @Inject()(userRepository: UserRepository, groupMembershipRepository: GroupMembershipRepository) {
   ...
   * @param role     represents rights see [[modules.user.model.Role]] management doc for more information
